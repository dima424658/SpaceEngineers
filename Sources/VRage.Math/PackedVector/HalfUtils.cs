        ...
        public static unsafe float Unpack(ushort value)
        {
            ...
            if ((value & -33792) == 0)
            {
                if ((value & 1023) != 0)
                {
                    ...
                    num1 = (uint)((value & 32768) << 16 | (int)num2 + (int)sbyte.MaxValue << 23 | (int)num4 << 13);
                }
                else
                    num1 = (uint)((value & 32768) << 16);
            }
            else
                num1 = (uint)((value & 32768) << 16 | (value >> 10 & 31) - 15 + sbyte.MaxValue << 23 | (value & 1023) << 13);
            return *(float*)&num1;
        }
    }
}
